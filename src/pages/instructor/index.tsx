...
function InstructorDashboardpage() {
    ...
    // Use the hook with pagination support
    const { data, isFetching, t, page, setPage, pagesArray } = useGetAllCourses();
    ...
    const menuItems = [
        ...
        },
        {
            ...
            component: (
                <div>
                    <InstructorCourses listOfCourses={data?.data} />
                    {/* Add pagination only for courses tab */}
                    {activeTab === 'courses' && pagesArray.length > 1 && (
                        <div className="mt-8">
                            <ReusablePagination
                                currentPage={page}
